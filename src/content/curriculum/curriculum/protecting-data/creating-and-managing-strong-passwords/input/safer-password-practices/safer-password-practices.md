...
breadcrumb: "Safer Password Practices"
date: "2015-05"
adids: "Input"
...
Again, don’t use the most [common passwords](http://gizmodo.com/the-25-most-popular-passwords-of-2015-were-all-such-id-1753591514), and don’t reuse passwords, especially for your most important accounts - these are the first thing that an adversary will try to use or guess.
<br><br>
...
- We now have so many passwords, and are adding more every day. How are we supposed to remember all of these strong and hard to remember passwords?
- When participants raise the point that it quickly becomes “too many to remember!", then take the opportunity to identify password managers (such as KeePass) as crucial aids that can help support more sustained use of strong passwords. Remind them also that the next portion of this session will cover these helpful tools.
...
Further services, aside from Gmail and other Google tools, offering two-factor authentication include Facebook, Dropbox, and Twitter. This website, [TwoFactorAuth](https://twofactorauth.org/) is an excellent tool for looking up accounts and services that currently support two-factor authentication. 
