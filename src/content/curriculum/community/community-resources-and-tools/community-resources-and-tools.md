...
Activist Checklist is a collection of plain-language digital security checklists for activists: practical, step-by-step guides on essentials like securing Signal, preparing for protests, reducing doxxing and harassment risk, setting up a secondary ("burner") phone, travel and flight safety, and building an emergency support network if you are detained or threatened.

- Languages: English, [Spanish](https://activistchecklist.org/es/)
- Updated: ![Last Updated](https://img.shields.io/github/last-commit/ActivistChecklist/ActivistChecklist?label=Last%20updated)
- [https://activistchecklist.org/](https://activistchecklist.org/)
