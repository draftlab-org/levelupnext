...
##### As digital security trainers in the current age, we face a challenge that other trainers do not:
...
##### Remember that if we push people into the *Orange Zone* or start triggering the traumatic memories of the *Red Zone*, we run the risk of losing them altogether.
...
##### She then asks her class to think about what they would do if this happened to them. 
